...
This project is a simple pokemon application built with HTML, CSS, and JavaScript. The program allows users to search for Pokemon using a pokemon api.
...
git clone https://github.com/Aryangoel225/Pokemon-program 
...
Once the index.html file is open in your browser, you can interact with the program, by input the name you wish to search and it shows a photo. 
